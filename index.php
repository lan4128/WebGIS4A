...
map = new ol.Map({
	...
	layers: [Basemap,
	 ...
	 new  ol.layer.Tile({
			...
			LegentType :'ESRI',
			InfoPopup : false,
			metadata : 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_CH_Dasarian_I_Januari_2021_AR_250K/info/iteminfo',
			visible: true
	 }),
   new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
			...
			LegentType :'ESRI',
			InfoPopup : false,
			metadata : 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_JALAN_PROVINSI/info/iteminfo',
			visible: true
	 }),
   new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/Kalsel_Toponimi/MapServer',
				}),
			name: 'Toponimi',
			LegenUrl: '',
			LegentType :'ESRI',
			InfoPopup : false,
			metadata : 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/Kalsel_Toponimi/info/iteminfo',
			visible: true
	 }),
   new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
			...
			LegentType :'ESRI',
			InfoPopup : false,
			metadata : 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_BANJIR_2021_PT_50K/info/iteminfo',
			visible: true
	 })
	 ],
	target: 'map',
